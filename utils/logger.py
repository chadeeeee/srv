...
# Contextual logger for trading operations
...
def position_closed_with_details(pair, direction, reason, close_price, rsi_value=None, entry_price=None):
    ...
    try:
        ...
        if entry_price:
            pnl_percent = ((close_price - entry_price) / entry_price * 100) if direction == "long" else ((entry_price - close_price) / entry_price * 100)
